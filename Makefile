#############################################################################
# Makefile for building: QtExample.app/Contents/MacOS/QtExample
...
DISTDIR = /Users/marksamwaiel/Desktop/untitled\ folder\ 2/.vscode/.tmp/QtExample1.0.0
...
DESTDIR       = 
TARGET        = QtExample.app/Contents/MacOS/QtExample

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/marksamwaiel/Desktop/untitled folder 2/.vscode/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/marksamwaiel/Desktop/untitled folder 2/.vscode/project.pro
...
QtExample.app/Contents/MacOS/QtExample:  $(OBJECTS)  
	@test -d QtExample.app/Contents/MacOS/ || mkdir -p QtExample.app/Contents/MacOS/
...
QtExample.app/Contents/PkgInfo: 
	@test -d QtExample.app/Contents || mkdir -p QtExample.app/Contents
	@$(DEL_FILE) QtExample.app/Contents/PkgInfo
	@echo "APPL????" > QtExample.app/Contents/PkgInfo
QtExample.app/Contents/Info.plist: 
	@test -d QtExample.app/Contents || mkdir -p QtExample.app/Contents
	@$(DEL_FILE) QtExample.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,Mark.QtExample,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},Mark.QtExample,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,QtExample,g" -e "s,@LIBRARY@,QtExample,g" -e "s,\$${EXECUTABLE_NAME},QtExample,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >QtExample.app/Contents/Info.plist

all: Makefile \
		QtExample.app/Contents/PkgInfo \
		QtExample.app/Contents/Info.plist QtExample.app/Contents/MacOS/QtExample
...
main.o: src/main.cpp /opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
