/****************************************************************************
** Meta object code from reading C++ file 'MinesweeperCellButton.hpp'
**
...
#include "src/view/MinesweeperCellButton.hpp"
...
#error "The header file 'MinesweeperCellButton.hpp' doesn't include <QObject>."
...
void CellButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CellButton::*)(int , int );
...
// SIGNAL 0
void CellButton::cellClicked(int _t1, int _t2)
{
